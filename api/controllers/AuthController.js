...
const loginhistoryStatus = sails.config.common.loginhistoryStatus;
const loginhistoryStatusName = sails.config.common.loginhistoryStatusName;
        ...
        User.comparePassword(password, user, function(err, valid) {
          ...
          if (!valid) {
            ...
            Loginhistory.create({
                ...
                statusName: loginhistoryStatusName,
                loginowner: user.id
              })
              .exec(function(err, createLoginHistory) {
                ...
                if (user.tfastatus) {
                  ...
                  console.log("Returnin user detailsss"+JSON.stringify());
                  res.json({
                    user: user,
                    statusCode: 200,
                    // token: jwToken.issue({
